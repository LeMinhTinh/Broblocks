// Shows a white info bubble containing <text> with its tip at <tipX/tipY>.
// Text has to contain explicit newlines (no auto word wrap).
...
Item {
    ...
    Item {
        ...
        Image {
            id: bubblePointer
            source: "file:resources/icons/BubblePointer.png"
